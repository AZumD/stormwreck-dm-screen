(function () {
  ...
  const SECTION_TITLES = {
    ...
    Combat: "Strid",
    "Combat stats": "Stridsvärden",
    Stats: "Värden",
    Abilities: "Grundegenskaper",
    "Ability scores": "Grundegenskaper",
    "Features & spellcasting": "Förmågor & magi",
    "Notes & tags": "Anteckningar & taggar",
    "Story & notes": "Berättelse & anteckningar",
    Casting: "Kastning",
    Effect: "Effekt",
    "Campaign links": "Kampanjkopplingar",
    "Inhabitants & points of interest": "Invånare & intressanta platser",
    Magic: "Magi",
    Media: "Media"
  };
  ...
  const FIELD_LABELS = {
    ...
    cr: "CR",
    xp: "XP",
    damageVulnerabilities: "Skadesårbarheter",
